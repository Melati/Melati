  ...
  */   
  public void generateBaseMethods(Writer w) throws IOException {
    ...
    w.write("\n" +
      ...
      "get"+capitalisedTargetFieldName+"Column().firstWhereEq(keyValue).troid();\n" +
      "  }\n" +
      "\n");
    w.write(
      "\n /**\n"
    ...
    w.write(
      "\n /**\n"
      + "  * Set the " + capitalisedName + " having validated it against " 
      + capitalisedTargetFieldName + "." + targetFieldName + " .\n" 
      + "  * \n"
