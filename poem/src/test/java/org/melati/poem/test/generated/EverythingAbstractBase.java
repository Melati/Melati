...
/**
 * Melati POEM generated base class for persistent EverythingAbstract.
 * Field summary for SQL table everythingabstract:
 *   binaryfield
 *   stringfield
 *   passwordfield
 *   booleanfield
...
public abstract class EverythingAbstractBase extends Persistent {
  ...
  public void setBinaryfield(byte[] cooked)
    ...
    _getEverythingAbstractTable().getBinaryfieldColumn().getType().assertValidCooked(cooked);
    writeLock();
  ...
  public void setStringfield(String cooked)
      throws AccessPoemException, ValidationPoemException {
    _getEverythingAbstractTable().getStringfieldColumn().getType().assertValidCooked(cooked);
    writeLock();
  ...
  public void setPasswordfield(String cooked)
      throws AccessPoemException, ValidationPoemException {
    _getEverythingAbstractTable().getPasswordfieldColumn().getType().assertValidCooked(cooked);
    writeLock();
  ...
  public void setBooleanfield(Boolean cooked)
      throws AccessPoemException, ValidationPoemException {
    _getEverythingAbstractTable().getBooleanfieldColumn().getType().assertValidCooked(cooked);
    writeLock();
  ...
  public void setDatefield(Date cooked)
      throws AccessPoemException, ValidationPoemException {
    _getEverythingAbstractTable().getDatefieldColumn().getType().assertValidCooked(cooked);
    writeLock();
  ...
  public void setDoublefield(Double cooked)
      throws AccessPoemException, ValidationPoemException {
    _getEverythingAbstractTable().getDoublefieldColumn().getType().assertValidCooked(cooked);
    writeLock();
  ...
  public void setIntegerfield(Integer cooked)
      throws AccessPoemException, ValidationPoemException {
    _getEverythingAbstractTable().getIntegerfieldColumn().getType().assertValidCooked(cooked);
    writeLock();
  ...
  public void setLongfield(Long cooked)
      throws AccessPoemException, ValidationPoemException {
    _getEverythingAbstractTable().getLongfieldColumn().getType().assertValidCooked(cooked);
    writeLock();
  ...
  public void setBigdecimalfield(BigDecimal cooked)
      throws AccessPoemException, ValidationPoemException {
    _getEverythingAbstractTable().getBigdecimalfieldColumn().getType().assertValidCooked(cooked);
    writeLock();
  ...
  public void setTimestampfield(Timestamp cooked)
      throws AccessPoemException, ValidationPoemException {
    _getEverythingAbstractTable().getTimestampfieldColumn().getType().assertValidCooked(cooked);
    writeLock();
