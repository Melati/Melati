...
/**
 * The JDBC4.1 members of a {@link Statement}, 
...
public abstract class ThrowingStatementJdbc4_1 
 ...
 public void closeOnCompletion() throws SQLException {
     if (shouldThrow(this.getClass().getInterfaces()[0], "closeOnCompletion"))
         throw new SQLException("Statement.closeOnCompletion() bombed");
 }

 @Override
 public boolean isCloseOnCompletion() throws SQLException {
     if (shouldThrow(this.getClass().getInterfaces()[0], "isWrapperFor"))
         throw new SQLException("Statement.isCloseOnCompletion() bombed");
