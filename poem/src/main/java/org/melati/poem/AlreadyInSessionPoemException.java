 ...
 * 
 * If the current {@link AccessToken} does not grant the appropriate {@link Capability} 
 * then the change it, do not open a new session. 
 * 
 * @author timp
 * @since 27/11/2006
 */
public class AlreadyInSessionPoemException extends PoemException {
   ...
   * Constructor.
   */
  public AlreadyInSessionPoemException() {
    super();
  }
