...
/**
 * The JDBC4.1 members of a {@link DatabaseMetaData}, 
...
public abstract class ThrowingDatabaseMetaDataJdbc4_1 
  ...
  public ResultSet getPseudoColumns(String catalog, String schemaPattern,
    ...
    if (shouldThrow(this.getClass().getInterfaces()[0], "getPseudoColumns"))
  ...
  public boolean generatedKeyAlwaysReturned() throws SQLException {
    if (shouldThrow(this.getClass().getInterfaces()[0], "generatedKeyAlwaysReturned"))
