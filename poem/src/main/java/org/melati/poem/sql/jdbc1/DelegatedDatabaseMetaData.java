...
public class DelegatedDatabaseMetaData implements java.sql.DatabaseMetaData {
  protected java.sql.DatabaseMetaData peer;
  public DelegatedDatabaseMetaData(java.sql.DatabaseMetaData peer) {
    this.peer = peer;
  }
