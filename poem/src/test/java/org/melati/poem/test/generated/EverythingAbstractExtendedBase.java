...
/**
 * Melati POEM generated base class for persistent EverythingAbstractExtended.
...
public abstract class EverythingAbstractExtendedBase extends EverythingAbstract {
  ...
  public void setId(Integer cooked)
    ...
    _getEverythingAbstractExtendedTable().getIdColumn().getType().assertValidCooked(cooked);
    writeLock();
    setId_unsafe(cooked);
  }
  ...
  public void setBinaryfield2(byte[] cooked)
      throws AccessPoemException, ValidationPoemException {
    _getEverythingAbstractExtendedTable().getBinaryfield2Column().getType().assertValidCooked(cooked);
    writeLock();
  ...
  public void setStringfield2(String cooked)
      throws AccessPoemException, ValidationPoemException {
    _getEverythingAbstractExtendedTable().getStringfield2Column().getType().assertValidCooked(cooked);
    writeLock();
  ...
  public void setPasswordfield2(String cooked)
      throws AccessPoemException, ValidationPoemException {
    _getEverythingAbstractExtendedTable().getPasswordfield2Column().getType().assertValidCooked(cooked);
    writeLock();
  ...
  public void setBooleanfield2(Boolean cooked)
      throws AccessPoemException, ValidationPoemException {
    _getEverythingAbstractExtendedTable().getBooleanfield2Column().getType().assertValidCooked(cooked);
    writeLock();
  ...
  public void setDatefield2(Date cooked)
      throws AccessPoemException, ValidationPoemException {
    _getEverythingAbstractExtendedTable().getDatefield2Column().getType().assertValidCooked(cooked);
    writeLock();
  ...
  public void setDoublefield2(Double cooked)
      throws AccessPoemException, ValidationPoemException {
    _getEverythingAbstractExtendedTable().getDoublefield2Column().getType().assertValidCooked(cooked);
    writeLock();
  ...
  public void setIntegerfield2(Integer cooked)
      throws AccessPoemException, ValidationPoemException {
    _getEverythingAbstractExtendedTable().getIntegerfield2Column().getType().assertValidCooked(cooked);
    writeLock();
  ...
  public void setLongfield2(Long cooked)
      throws AccessPoemException, ValidationPoemException {
    _getEverythingAbstractExtendedTable().getLongfield2Column().getType().assertValidCooked(cooked);
    writeLock();
  ...
  public void setBigdecimalfield2(BigDecimal cooked)
      throws AccessPoemException, ValidationPoemException {
    _getEverythingAbstractExtendedTable().getBigdecimalfield2Column().getType().assertValidCooked(cooked);
    writeLock();
  ...
  public void setTimestampfield2(Timestamp cooked)
      throws AccessPoemException, ValidationPoemException {
    _getEverythingAbstractExtendedTable().getTimestampfield2Column().getType().assertValidCooked(cooked);
    writeLock();
